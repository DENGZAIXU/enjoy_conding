...
#category_set = dict()
image_set = set()
image_id = 201910001  # train:2018xxx; val:2019xxx; test:2020xxx
category_item_id = 1
annotation_id = 1
category_set = ['a','b','c','d','e','f','g','h','i','j'] #这里填写好检测的类别
'''
def addCatItem(name):
...
if __name__ == '__main__':
    #xml_path = '/home/luyukun/labelImg-master/all/xml'
    #json_file = '/home/luyukun/labelImg-master/train.json'
    xml_path = '/home/algoteam2/xu/train_data/ann/'
    json_file = '/home/algoteam2/xu/train_data/train.json'
